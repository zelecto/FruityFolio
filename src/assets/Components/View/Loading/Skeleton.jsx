    ...
    return (
        <div className="w-96 h-[420px] bg-gray-200 p-4 rounded-lg shadow-md my-10">
            <div className="animate-pulse">
                ...
                <h3 className="text-xl font-bold text-center mb-2 bg-gray-300 h-8 rounded"></h3>
            ...
            <div className="w-2/3">
                {[...Array(numRows)].map((_, index) => (
                    <div key={index} className="flex justify-between p-5 mb-4 bg-gray-200 rounded-lg shadow-md">
                        <div className="w-1/2">
                            {[...Array(4)].map((_, index) => (
                                <p key={index} className="font-bold text-center mb-2 bg-gray-300 h-6 rounded"></p>
                            ))}
                        </div>
                        <div className="w-1/5 flex flex-col justify-between">
                            {[...Array(2)].map((_, index) => (
                                <p key={index} className="font-bold text-center mb-[5px] bg-gray-300 h-8 rounded-full"></p>
                            ))}
                        </div>
                    </div>
                ))}
